...
public class RecommendationByName{
    ...
    private static final String RECOMMENDATION_OF_Top_Saving =
            """
    ...
    private static final String RECOMMENDATION_OF_SIMPLE_LOAN =
            """
    ...
    public static String getRecommendationByName(String name){
        ...
        } else if (name.equals("Top Saving")) {
            return RECOMMENDATION_OF_Top_Saving;
        } else if (name.equals("Простой кредит")) {
            return RECOMMENDATION_OF_SIMPLE_LOAN;
        }else return null;
    }
}
